...
const auto SCORE_HEIGHT = RESOLUTION_HEIGHT / 6;
// the half of the score indicator height.
const auto SCORE_HALF_HEIGHT = SCORE_HEIGHT / 2;

// the line thickness for score indicator numbers.
const auto SCORE_THICKNESS = SCORE_HEIGHT / 5;
// the half of the score indicator line thickness.
const auto SCORE_HALF_THICKNESS = SCORE_THICKNESS / 2;

// the x-coordinate of the up-left position of the left score number.
const auto LEFT_SCORE_X = (RESOLUTION_WIDTH / 2) - (2 * SCORE_WIDTH);
// the x-coordinate of the up-left position of the right score number.
const auto RIGHT_SCORE_X = (RESOLUTION_WIDTH / 2) + SCORE_WIDTH;
// the y-coordinate of the up-left position of the left score number.
const auto SCORE_Y = RESOLUTION_HEIGHT / 10;

// the vector containing all possible numbers at the left side of the scene.
const std::vector<std::vector<SDL_Rect>> LEFT_NUMBERS = {
  { // number 0
    { LEFT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
    { LEFT_SCORE_X, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT },
    { LEFT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT},
    { LEFT_SCORE_X, SCORE_Y + SCORE_HEIGHT - SCORE_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS }
  },
  { // number 1
    { LEFT_SCORE_X + SCORE_HALF_HEIGHT - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT }
  },
  { // number 2
    { LEFT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
    { LEFT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HALF_HEIGHT },
    { LEFT_SCORE_X, SCORE_Y + SCORE_HALF_HEIGHT - SCORE_HALF_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS},
    { LEFT_SCORE_X , SCORE_Y + SCORE_HALF_HEIGHT, SCORE_THICKNESS, SCORE_HALF_HEIGHT },
    { LEFT_SCORE_X, SCORE_Y + SCORE_HEIGHT - SCORE_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS }
  },
  { // number 3
    { LEFT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
  ...
  { // number 4
    { LEFT_SCORE_X, SCORE_Y, SCORE_THICKNESS, SCORE_HALF_HEIGHT},
    { LEFT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT},
    { LEFT_SCORE_X, SCORE_Y + SCORE_HALF_HEIGHT - SCORE_HALF_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS}
  },
  { // number 5
    ...
    { LEFT_SCORE_X, SCORE_Y, SCORE_THICKNESS, SCORE_HALF_HEIGHT},
    { LEFT_SCORE_X, SCORE_Y + SCORE_HALF_HEIGHT - SCORE_HALF_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS},
    { LEFT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y + SCORE_HALF_HEIGHT, SCORE_THICKNESS, SCORE_HALF_HEIGHT},
    { LEFT_SCORE_X, SCORE_Y + SCORE_HEIGHT - SCORE_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS }
  },
  { // number 6
    { LEFT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
...
// the vector containing all possible numbers at the right side of the scene.
const std::vector<std::vector<SDL_Rect>> RIGHT_NUMBERS = {
  { // number 0
    { RIGHT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
    { RIGHT_SCORE_X, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT },
    { RIGHT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT},
    { RIGHT_SCORE_X, SCORE_Y + SCORE_HEIGHT - SCORE_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS }
  },
  { // number 1
    { RIGHT_SCORE_X + SCORE_HALF_HEIGHT - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT }
  },
  { // number 2
    { RIGHT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
    { RIGHT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HALF_HEIGHT },
    { RIGHT_SCORE_X, SCORE_Y + SCORE_HALF_HEIGHT - SCORE_HALF_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS},
    { RIGHT_SCORE_X , SCORE_Y + SCORE_HALF_HEIGHT, SCORE_THICKNESS, SCORE_HALF_HEIGHT },
    { RIGHT_SCORE_X, SCORE_Y + SCORE_HEIGHT - SCORE_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS }
  },
  { // number 3
    { RIGHT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
  ...
  { // number 4
    { RIGHT_SCORE_X, SCORE_Y, SCORE_THICKNESS, SCORE_HALF_HEIGHT},
    { RIGHT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y, SCORE_THICKNESS, SCORE_HEIGHT},
    { RIGHT_SCORE_X, SCORE_Y + SCORE_HALF_HEIGHT - SCORE_HALF_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS}
  },
  { // number 5
    ...
    { RIGHT_SCORE_X, SCORE_Y, SCORE_THICKNESS, SCORE_HALF_HEIGHT},
    { RIGHT_SCORE_X, SCORE_Y + SCORE_HALF_HEIGHT - SCORE_HALF_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS},
    { RIGHT_SCORE_X + SCORE_WIDTH - SCORE_THICKNESS, SCORE_Y + SCORE_HALF_HEIGHT, SCORE_THICKNESS, SCORE_HALF_HEIGHT},
    { RIGHT_SCORE_X, SCORE_Y + SCORE_HEIGHT - SCORE_THICKNESS, SCORE_WIDTH, SCORE_THICKNESS }
  },
  { // number 6
    { RIGHT_SCORE_X, SCORE_Y, SCORE_WIDTH, SCORE_THICKNESS },
...
int main(int argc, char* argv[]) {
  ...
  while (isRunning) {
    ...
    SDL_RenderFillRects(renderer, &LEFT_NUMBERS[sScores[0]][0], LEFT_NUMBERS[sScores[0]].size());
    SDL_RenderFillRects(renderer, &RIGHT_NUMBERS[sScores[1]][0], RIGHT_NUMBERS[sScores[1]].size());
